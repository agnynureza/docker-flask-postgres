...
CREATE ROLE myuser;
ALTER ROLE myuser WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:7tmOwsxee+wRIVLA68wa0w==$HGhNzchbMrOX+xSrkek14oZZJ15B0yvannb2tMgaD38=:3BdgMkgIRJkkwO6wDXhoIWUzRDFm8+Yv0XDoHnnNDIA=';
...
ALTER TABLE public.tasks_id_seq OWNER TO myuser;
